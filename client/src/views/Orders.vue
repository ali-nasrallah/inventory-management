<template>
  <div class="orders">
    ...
    <div v-else>
      ...
      <!-- Submitted Orders (restocking orders) -->
          ...
          <table class="orders-table">
            ...
            <tbody>
              <tr v-for="order in submittedOrders" :key="order.id">
                ...
                <td class="col-lead">{{ t('orders.table.leadTimeDays', { days: leadTime(order) }) }}</td>
...
export default {
  ...
  setup() {
    ...
    const leadTime = (order) => {
      ...
      const days = Math.ceil((delivery - new Date()) / 86400000)
